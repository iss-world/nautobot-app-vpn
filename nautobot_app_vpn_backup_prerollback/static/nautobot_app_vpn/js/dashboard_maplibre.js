    ...
    <details>
      ...
      <div class="legend-body">
        <div class="legend-section">
          <div class="legend-item"><span class="legend-line"></span><span>Primary (solid)</span></div>
          <div class="legend-item"><span class="legend-line secondary"></span><span>Secondary (dashed)</span></div>
          <div class="legend-item"><span class="legend-line tertiary"></span><span>Tertiary / other (dotted)</span></div>
        </div>
        <div class="legend-section">
          <div class="legend-item"><span class="legend-swatch internal"></span><span>Internal scope</span></div>
          <div class="legend-item"><span class="legend-swatch external"></span><span>External scope</span></div>
          <div class="legend-item"><span class="legend-swatch failed"></span><span>Failed / down</span></div>
          <div class="legend-item"><span class="legend-swatch planned"></span><span>Planned</span></div>
        </div>
        <div class="legend-section">
          <div class="legend-item"><span class="legend-node ok"></span><span>Device healthy</span></div>
          <div class="legend-item"><span class="legend-node degraded"></span><span>Device degraded</span></div>
          <div class="legend-item"><span class="legend-node down"></span><span>Device down</span></div>
          <div class="legend-item"><span class="legend-node highlight"></span><span>Search highlight</span></div>
        </div>
      </div>
    </details>
  `;
  ...
  function initMap() {
    ...
    const legendControl = {
      onAdd() {
        ...
        this._container.className = "map-legend-control maplibregl-ctrl";
