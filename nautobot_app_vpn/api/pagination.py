...
class StandardResultsSetPagination(PageNumberPagination):
    ...
    page_size = 25  # ✅ Default results per page (better balance between performance & usability)
    page_size_query_param = "page_size"  # ✅ Allow users to customize page size
    max_page_size = 200  # ✅ Increased to support large data exports safely
    last_page_strings = ("last",)  # ✅ Allow users to use `?page=last` for easy navigation
