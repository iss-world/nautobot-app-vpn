    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liveness_check_interval', models.PositiveIntegerField(blank=True, default=5, validators=[django.core.validators.MinValueValidator(1)])),
                ('last_sync', models.DateTimeField(blank=True)),
                ('bind_interface', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ikegateway_binds', to='dcim.interface')),
                ...
                ('local_platform', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='local_ike_gateways', to='dcim.platform')),
                ...
                ('peer_platform', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='peer_ike_gateways', to='dcim.platform')),
                ('status', nautobot.extras.models.statuses.StatusField(default=nautobot_app_vpn.utils.get_default_status, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_related', to='extras.status')),
                ('tags', nautobot.core.models.fields.TagsField(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monitor_profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ipsec_tunnels', to='nautobot_app_vpn.tunnelmonitorprofile')),
                ('status', nautobot.extras.models.statuses.StatusField(default=nautobot_app_vpn.utils.get_default_status, on_delete=django.db.models.deletion.PROTECT, related_name='%(app_label)s_%(class)s_related', to='extras.status')),
                ('tags', nautobot.core.models.fields.TagsField(through='extras.TaggedItem', to='extras.Tag')),
