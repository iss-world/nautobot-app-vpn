# Generated by Django 4.2.23 on 2025-08-01 11:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "authentication",
                    models.ManyToManyField(related_name="ikecryptos", to="nautobot_app_vpn.authenticationalgorithm"),
                ),
                (
                    "dh_group",
                    models.ManyToManyField(related_name="ikecryptos", to="nautobot_app_vpn.diffiehellmangroup"),
                ),
                (
                    "encryption",
                    models.ManyToManyField(related_name="ikecryptos", to="nautobot_app_vpn.encryptionalgorithm"),
                ),
                (
                    "status",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("local_ip", models.CharField(blank=True, default="", max_length=255)),
                ("local_id_type", models.CharField(blank=True, default=None, max_length=20, null=True)),
                ("local_id_value", models.CharField(blank=True, default=None, max_length=255, null=True)),
                ("peer_ip_type", models.CharField(default="ip", max_length=20)),
                ("peer_ip", models.CharField(blank=True, default="", max_length=255)),
                ("peer_device_manual", models.CharField(blank=True, default="", max_length=255)),
                ("peer_location_manual", models.CharField(blank=True, default="", max_length=255)),
                ("peer_id_type", models.CharField(blank=True, default=None, max_length=20, null=True)),
                ("peer_id_value", models.CharField(blank=True, default=None, max_length=255, null=True)),
                ("authentication_type", models.CharField(max_length=20)),
                ("pre_shared_key", models.TextField(blank=True, default="")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "authentication",
                    models.ManyToManyField(related_name="ipsec_cryptos", to="nautobot_app_vpn.authenticationalgorithm"),
                ),
                (
                    "dh_group",
                    models.ManyToManyField(related_name="ipsec_cryptos", to="nautobot_app_vpn.diffiehellmangroup"),
                ),
                (
                    "encryption",
                    models.ManyToManyField(related_name="ipsec_cryptos", to="nautobot_app_vpn.encryptionalgorithm"),
                ),
                (
                    "status",
                    nautobot.extras.models.statuses.StatusField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("monitor_destination_ip", models.CharField(blank=True, default="", max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(auto_created=True, primary_key=True, serialize=False)),
                ("local_subnet", models.CharField(blank=True, default="", max_length=50)),
                ("remote_subnet", models.CharField(blank=True, default="", max_length=50)),
