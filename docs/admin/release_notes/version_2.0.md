...
- Raised the Nautobot compatibility floor to >= 3.0,<4.0 and validated against 3.0.1.
...
- Updated `pyproject.toml`, `poetry.lock`, and plugin metadata to require Nautobot >= 3.0,<4.0 and Python 3.11+.
